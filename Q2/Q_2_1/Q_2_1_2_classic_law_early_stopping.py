...
默认运行：
    ...
    python Q2/Q_2_1/Q_2_1_2_classic_law_early_stopping.py

结果写入 ``results/scaling_law_early_stopping/``。
"""
...
from Q_2_1_1_classic_law import Observation, fit_scaling_law


DEFAULT_B_DIR = _q2_paths.B_DATA
DEFAULT_OUTPUT_DIR = (
    _q2_paths.ANALYSIS_DIR / "scaling_law_early_stopping"
)
