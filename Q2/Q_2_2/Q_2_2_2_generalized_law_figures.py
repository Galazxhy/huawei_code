...
``results/Q_1_to_2/generalized_scaling_compact.json``; a mismatch is raised
as an error rather than silently drawn.

Usage::

    MPLCONFIGDIR=$PWD/.mplcfg python Q2/Q_2_2/Q_2_2_2_generalized_law_figures.py
    MPLCONFIGDIR=$PWD/.mplcfg python Q2/Q_2_2/Q_2_2_2_generalized_law_figures.py \\
        --figures all
"""
...
COMPACT_JSON = _q2_paths.HANDOFF_IN / "generalized_scaling_compact.json"
HANDOFF_DIR = _q2_paths.HANDOFF_OUT
CLASSIC_JSON = _q2_paths.CLASSIC_RESULTS
DEFAULT_OUTPUT_DIR = _q2_paths.ANALYSIS_DIR / "generalized_scaling_law_drawings"
