...
产出::
    ...
    data_analysis/Q2_to_Q3/paired_cross_scale_identification.json
    data_analysis/Q2_to_Q3/配对跨规模回归辨识.md

用法::

    MPLCONFIGDIR=$PWD/.mplcfg python q2/handoff_identification.py
"""
...
def main() -> None:
    ...
    lines = [
        "# 配对跨规模回归辨识（PCXI）",
        "",
        "本文件由 `q2/handoff_identification.py` 生成。",
        "",
        "## 1. 核心恒等式",
        "",
