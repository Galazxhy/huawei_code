...
OUTPUT = _q2_paths.ANALYSIS_DIR / "quality_mixture_elasticity"
QUALITY_DESIGN = (_q2_paths.B_DATA / "supplementary_NQ_experiment_expanded.csv")
...
def quality_factorial_grid(fits: dict) -> tuple[list[dict], dict]:
    ...
    grid_info = {
        "source": _q2_paths.repo_relative(QUALITY_DESIGN),
...
def analyse(output_dir: Path) -> dict:
    ...
    payload = {
        ...
        "source_files": [
            "results/Q2_to_Q3/elasticity_and_substitution.json",
            "results/Q2_to_Q3/generalized_scaling_law.json",
            "results/Q2_to_Q3/mixture_response.json",
            "results/Q_1_to_2/Q17_mapping.csv",
    ...
    lines += [
        ...
        "",
        "运行 `python Q2/Q_2_4/Q_2_4_1_elasticity_analysis.py` 更新数据与报告，"
        "再运行 `python Q2/Q_2_4/Q_2_4_2_elasticity_figures.py` 更新图像。",
        "",
    ]
