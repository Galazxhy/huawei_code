...
Q3_RESULT = ROOT.parents[1] / "Q3_pz" / "04_关键结果" / "result_q3_cost_allocation.csv"
...
def load_q3_anchors(cost_form: str = "exponential") -> list[tuple[float, float]]:
    ...
    if keep.shape[0] != 3 or not np.allclose(keep["budget"], [1e19, 1e22, 1e24]):
        raise ValueError("Q3 main anchors are incomplete or use unexpected budgets")
